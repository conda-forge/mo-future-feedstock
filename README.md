...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mo-future-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7738&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mo-future-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mo-future` can be installed with:

```
conda install mo-future
```

It is possible to list all of the versions of `mo-future` available on your platform with:
